...
public class TTSUtility implements InitListener {
    ...
    public void speaking(String text) {
        ...
        if (mTts==null||mTtsListener==null||TextUtils.isEmpty(text))
        { return;}
    ...
    public final static String[] COLOUD_VOICERS_VALUE = {"xiaoyan", "xiaoyu", "vixy", "xiaoqi", "vixf", "xiaolin",
            "xiaoqian",  "nannan", "vils","aisjinger","aisxping"};
