...
public class SunriseView extends View {
    ...
    private void init(AttributeSet attrs) {
        ...
        motionPaint.setColor(Color.parseColor("#9A9A9A"));
        ...
        sunPaint.setColor(ColorUtil.WHITE);
        sunPaint.setStyle(Paint.Style.FILL);
        mSunPaint = sunPaint;
        // 太阳边框画笔
        Paint sunStrokePaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        sunStrokePaint.setColor(sunColor);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        // 画太阳
        canvas.drawCircle((float) rX, (float)rY, svSunSize*10/9, mSunStrokePaint);
