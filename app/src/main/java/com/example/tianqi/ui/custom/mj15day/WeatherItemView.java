...
public class WeatherItemView extends LinearLayout {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mTopBg= rootView.findViewById(R.id.rl_top_bg);
    ...
    public void setBg(boolean b) {
        tvWeek.setTextColor(b?Color.BLACK: ColorUtil.WEEK_COLOR);
        mTopBg.setBackground(this.getResources().getDrawable(b?R.drawable.shape_day15_bg:R.drawable.shape_day15,null));
    }
