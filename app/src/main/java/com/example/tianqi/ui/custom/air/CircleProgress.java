package com.example.tianqi.ui.custom.air;
...
public class CircleProgress extends View {
    ...
    private void drawText(Canvas canvas) {
        ...
        //canvas.drawText(String.format(mPrecisionFormat, mValue), mCenterPoint.x, mValueOffset+100, mValuePaint);

        if (mHint != null) {
            canvas.drawText(mHint.toString(), mCenterPoint.x, mHintOffset+40, mValuePaint);
        }
