...
public class TemperatureView extends View {
    ...
    private void initPaint(Context context, AttributeSet attrs) {
        ...
        pointPaintSide.setColor(pointColor);
        pointPaintSide.setAntiAlias(true);
        pointPaintSide.setStyle(Paint.Style.STROKE);
        pointPaintSide.setStrokeWidth(3);
    ...
    private void drawPoint(Canvas canvas) {
        ...
        pointPaintSide.setColor(ColorUtil.HIGH15);
        canvas.drawCircle(x, y, radius, pointPaintSide);

        canvas.drawCircle(x2, y2, radius, pointPaint);
        pointPaintSide.setColor(ColorUtil.LOW15);
        canvas.drawCircle(x2, y2, radius, pointPaintSide);
