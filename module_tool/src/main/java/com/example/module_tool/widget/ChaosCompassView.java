...
//        mTextPaint.setStyle(Paint.Style.STROKE);
        ...
        mOutSideCircumPaint.setColor(context.getResources().getColor(R.color.light_white));
        ...
        mCenterPaint.setColor(context.getResources().getColor(R.color.yellow));
...
//        set3DMetrix();
    ...
    private void drawCenterText() {
        ...
        if (val<0){
            ...
            centerValue= Math.abs(val);
        }
        String centerText= String.valueOf((int) (centerValue)+"°");
    ...
    private void drawCompassDegreeScale() {
        ...
        for (int i = 0; i < 240; i++) {
            ...
            if (i==0||i==60||i==120||i==180){
                mDeepGrayPaint.setColor(Color.WHITE);
                ...
                mLightGrayPaint.setColor(Color.GRAY);
                mLightGrayPaint.setStrokeWidth(1f);
                mCanvas.drawLine(getWidth() / 2, mTextHeight+mOutSideRadius-mCircumRadius+10,
                        getWidth() / 2,  mTextHeight+mOutSideRadius-mCircumRadius+30, mLightGrayPaint);
            }
            mSamllDegreePaint.setColor(Color.WHITE);
            if (i==0){
                mCanvas.drawText(getContext().getText(R.string.north).toString(), this.width /2-mPositionTextWidth/2,mTextHeight+mOutSideRadius-mCircumRadius+40+mPositionTextHeight,mNorthPaint);
            }else if (i==60){
                mCanvas.drawText(getContext().getText(R.string.east).toString(), this.width /2-mPositionTextWidth/2,mTextHeight+mOutSideRadius-mCircumRadius+40+mPositionTextHeight,mOthersPaint);
            }else if (i==120){
                mCanvas.drawText(getContext().getText(R.string.south).toString(), this.width /2-mPositionTextWidth/2,mTextHeight+mOutSideRadius-mCircumRadius+40+mPositionTextHeight,mOthersPaint);
            }else if (i==180){
                mCanvas.drawText(getContext().getText(R.string.west).toString(), this.width /2-mWPositionTextWidth/2,mTextHeight+mOutSideRadius-mCircumRadius+40+mWPositionTextHeight,mOthersPaint);
            }else if (i==20){
...
//        mCanvas.drawArc(width/2-mOutSideRadius,mTextHeight,width/2+mOutSideRadius,mTextHeight+mOutSideRadius*2,-120,-120,false,mDarkRedPaint);
    ...
    private void drawText() {
        int[] mOrientaionRes = new int[]{R.string.north, R.string.northeast, R.string.east, R.string.southeast,
                R.string.south, R.string.southwest, R.string.west, R.string.northwest};
        int index=((int) (val+22.5f)%360)/45;
        text=getContext().getResources().getString(mOrientaionRes[index%mOrientaionRes.length]);
