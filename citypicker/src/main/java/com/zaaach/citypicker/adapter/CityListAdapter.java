...
import com.zaaach.citypicker.util.DeviceUtils;
...
public class CityListAdapter extends RecyclerView.Adapter<CityListAdapter.BaseViewHolder> {
    ...
    private GridListAdapter mMAdapter;
    ...
    public CityListAdapter(Context context, List<City> data, List<HotCity> hotData, int state) {
        ...
        mMAdapter = new GridListAdapter(mContext, mHotData);
        mMAdapter.setData(locateState);
    }
    ...
    public void onBindViewHolder(@NonNull BaseViewHolder holder, int position) {
        ...
        if (holder instanceof LocationViewHolder){
            ...
            lp.width = DeviceUtils.getScreenWidth(mContext);
...
//                            }
        ...
        if (holder instanceof HotViewHolder){
            ...
            mMAdapter.setInnerListener(mInnerListener);
