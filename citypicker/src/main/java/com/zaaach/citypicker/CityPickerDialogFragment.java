...
public class CityPickerDialogFragment extends DialogFragment implements TextWatcher,
    ...
    private RelativeLayout city_bar;
    ...
    private void initViews() {
        ...
        iv_bar_back = mContentView.findViewById(R.id.iv_bar_back);
        city_bar = mContentView.findViewById(R.id.bar_include);
    ...
    public void onClick(View v) {
        int id = v.getId();
        if (id == R.id.iv_bar_back||id==R.id.cp_cancel) {
            dismiss();
            if (mOnPickListener != null){
                mOnPickListener.onCancel();
            }
